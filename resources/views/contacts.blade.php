...
<!-- <div class="row">
        ...
        <div class="col-md-3">
            ...
            <div class="overlay-black overflow-hidden position-relative"> <img src="{{ asset('/images/'.$property->image1) }}" alt="" class="img-fluid">
                <div class="sale bg-success text-white text-capitalize">For {{ $property->status }}</div>
                <div class="price text-primary">{{ $property->price }}</div>
            </div>
            <div class="featured-thumb-data shadow-one">
                <div class="p-3">
                    <h5 class="text-secondary hover-text-success mb-2 text-capitalize"><a href="#">{{ $property->description }}</a></h5>
                    <span class="location text-capitalize"><i class="fas fa-map-marker-alt text-success"></i> {{ $property->location }}</span> 
                </div>
            </div>
        </div>
        </div>
