        ...
        <div class="col-lg-7 px-5 pt-3">
            ...
            <h4>Register As Landlord</h4>
                    <form method="POST" action="{{ route('landlord.register') }}">
                        ...
                        <div class="form-row mb-2">
                            <div class="col-lg-7">
                                <input id="acc_number" type="number" class="form-control @error('acc_number') is-invalid @enderror" placeholder="Account Number" name="acc_number" value="{{ old('acc_number') }}" required autocomplete="acc_number" autofocus>
