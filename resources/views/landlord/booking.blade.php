            ...
            <div class="card-header pb-0">
              <div class="row">
                <div class="col-lg-6 col-7">
                  <h6 class="text-uppercase">booking history</h6>
                </div>
            ...
            <div class="card-body px-0 pb-2">
              ...
              <div class="table-responsive">
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder text-uppercase opacity-7">Name</th>
                      ...
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Assigned?</th>
                    </tr>
                  </thead>
                  <tbody>
