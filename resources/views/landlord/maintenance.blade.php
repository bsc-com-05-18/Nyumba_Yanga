...
@section('nav')
    <nav aria-label="breadcrumb">
        ...
        <h6 class="font-weight-bolder text-white mb-0">Maintenance</h6>
        </nav>
@endsection
            ...
            <div class="card-header pb-0">
              <div class="row">
                <div class="col-lg-6 col-7 ">
                  <h6 class="text-uppercase">maintenace history</h6>
                </div>
                ...
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      ...
                      <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">fault</th>
